...
export const IndexPage = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center gap-2 w-full h-full">
            <h1 className="font-bold text-3xl">Index Page (Mobile)</h1>
            <p className="max-w-2xl text-center">
                Mobile platform build of the IndexPage: the same shared route served as a SPA shell
                inside a native WebView. Open the drawer menu for mobile-only routes.
            </p>
